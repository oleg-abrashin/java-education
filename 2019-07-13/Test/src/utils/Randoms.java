...
public class Randoms {
	...
	public static Publisher getRandomPublisher() {
		return new Publisher(
				RandomLib.randomOfArray(PUBLISHER_NAMES),
				PROBABILITIES_MAP.higherEntry(RandomLib.gen.nextDouble()).getValue());
	}
	
	public static Author getRandomAuthor() {
		return new Author (RandomLib.randomOfArray(AUTHOR_NAMES),
							RandomLib.randomOfArray(AUTHOR_LAST_NAMES));
	}
	
	public static Title getRandomTitle() {
		return RandomLib.randomOfArray(TITLES);
